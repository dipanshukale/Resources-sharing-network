...
const Navbar = () => {
  return (
    <nav className="bg-white shadow-md text-gray-800 px-6 py-4 flex justify-between items-center">
      ...
      <button className="bg-[#0ABAB5] text-white px-4 py-2 rounded-full hover:bg-[#0ABAB5] transition">
        Login
      </button>
    </nav>
  );
