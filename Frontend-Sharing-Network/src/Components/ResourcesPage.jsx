...
const ResourcesPage = () => {
  return (
    ...
    <div className="max-w-6xl mx-auto text-center mb-16 z-10 relative">
      <h1 className="text-4xl lg:text-5xl sm:text-6xl font-light text-gray-900 drop-shadow-lg leading-tight tracking-tight">
        Study Stuff, Shared Loud!
      </h1>
      <p className="text-lg sm:text-xl text-gray-600 mt-4 font-light max-w-2xl mx-auto">
         Notes that slap. Books that guide. Tools that vibe. This ain't a repo — it’s a student drop zone
      </p>
    </div>
